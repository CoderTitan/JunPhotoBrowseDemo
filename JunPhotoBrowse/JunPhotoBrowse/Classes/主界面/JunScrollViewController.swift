...
class JunScrollViewController: UIViewController {
...
//MARK: collection代理
extension JunScrollViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
